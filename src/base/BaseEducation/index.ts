...
export const BaseEducation = [
  {
    ...
    descripition:
      "Curso Full Stack de Desenvolvedor com 2.000 horas, abrangendo tecnologias de Front End e Back End, bem como as soft skills necessárias para o mercado de trabalho. Entre as linguagens e tecnologias aprendidas estão: HTML5, CSS3, JavaScript (ES6+), React, Node.js, Python (Django e Flask) e Bancos de dados.",
  },
  {
    id: 2,
    img: udemylogo,
